...
module "compute" {
    ...
    apm_public_sg = "${module.networking.apm_public_sg}"
    apm_private_sg = "${module.networking.apm_private_sg}"
    apm_alb_sg = "${module.networking.apm_alb_sg}"
    apm_public_subnets = "${module.networking.apm_public_subnets}"
    apm_private_subnets = "${module.networking.apm_private_subnets}"
